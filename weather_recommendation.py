...
from chain.weather_fashion_chain import get_coordinates_chain, get_weather_chain, get_fashion_image_chain
...
def recommend_weather(region: str) -> Tuple[WeatherFashion, FashionImage]:
    ...
    # coordinates = json.loads(region_lookup_agent(region))
